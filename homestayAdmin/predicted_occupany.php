...
$pagename="Your Predicted Occupancy"; //create and populate variable called $pagename
...
if(isset($_SESSION['userId'])){
    ...
    echo "<form action='predicted_occupany.php' method='post'>";
    ...
    echo "</select>";
    echo "<input type='submit' name='search' value='Predict Occupany Rate' style='background-color: #4CAF50; /* Green */
    float:right;
    border: none;
    color: black;
    padding: 15px 32px;
        ...
        try{
            ...
            if($count < 15){
                ...
                foreach ($fcsv as $key => $value) {
                    ...
                    if ($temp[0] == $name) {
                        $command = escapeshellcmd("python PredictedOccupancy.py $name $month");
                ...
                if($visit=="false"){
                    ...
                    if($totalDays > 60){
                        ...
                        echo "Not Enough Bookings To Predict Occupancy Rate";
                    }
    ...
    echo "Please Login to View Your Predicted Occupany Rates";
}
