...
$pagename="Your Weather Forecast"; //create and populate variable called $pagename
...
<div class="container wrapper">
  ...
  <div class="row">
    <h3 class="title text-center bordered">Weather Report for Colombo</h3>
  ...
  <br><br>
  <div class="row">
    <h3 class="title text-center bordered">5 Days Weather Forecast for Colombo</h3>
